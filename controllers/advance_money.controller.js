...
const fs = require("fs");
const { Advance_Money, validate } = require("../models/advance_money.model");
...
exports.create = async (req, res) => {
  try {
    ...
    await new Advance_Money({ ...req.body }).save();
...
exports.update = async (req, res) => {
  try {
    ...
    Advance_Money.findByIdAndUpdate(
      id,
      { ...req.body },
...
exports.findAll = async (req, res) => {
  ...
  exports.delete = (req, res) => {
    ...
    Advance_Money.findByIdAndRemove(id, { useFindAndModify: false })
      .then((data) => {
        if (!data) {
          res.status(404).send({
